#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To SadmanShovik
...
---------------------------------------------
\033[1;96m|-------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-----|
\033[1;96m|               Developer: Sadman Shovik
\033[1;96m|                Facebook Cloning Tool
\033[1;96m|This Tool is Only for Bangladesh FB Acounts|
\033[1;96m|------+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+------|

\033[1;91m [⚡\033[1;97mAuthor Name: SadmanShovik  ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl: Dark Denti Official⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom:BD      ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mDarkDenti\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
\033[1;91m╚█████╔╝╚█████╔╝██║░╚═╝░██║███████╗
\033[1;91m░╚════╝░░╚════╝░╚═╝░░░░░╚═╝╚══════╝
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mDarDenti\033[1;95m-_-_-_-_-_-_-_-_-»
\033[1;92mNote1: Enter Tool username and Password 
\033[1;92mNote2: This Tool is only for Bangladesh
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mDarkDenti033[1;95m-_-_-_-_-_-_-_-_-»
 """
CorrectUsername = "Dark"
CorrectPassword = "Denti"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Sadman_Shovik
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;93mWrong Password"
            os.system('xdg-open https://www.facebook.com/100844855058735')
    else:
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mSubscribe Dark Denti.Official Youtube Channel " 
